...
export function normalizeTencentLanguages(voice: TencentVoiceRecord):
  ...
  if (Array.isArray(voice.LanguageCodes)) candidates.push(...voice.LanguageCodes);
  candidates.push(typeof voice.Language === "string" ? voice.Language : undefined);
  candidates.push(typeof voice.VoiceLanguage === "string" ? voice.VoiceLanguage : undefined);
